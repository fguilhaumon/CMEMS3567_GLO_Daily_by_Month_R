...
#Motu tools 
python="python"  #C:\Python27\ArcGISx6410.1\python.exe
 
motu_cl = "/home/franz/Dropbox/Me/ECOLOGIE/Coral_reefs/Nouvelle_Caledo/stage_Floriant/data_env_copernicus/motu-client-python-master/src/python/motu-client.py" 
 
# Login Credentials - Motu Server and chosen Product/Dataset 
log_cmems="-u lnerriere" 
pwd_cmems="-p 20152016" 
...
# Variables 
table_var_cmd=["-v thetao"] 
table_data_type=["TEMP_",] #There are four data type since we'll download four datasets 
 
# Output files 
out_path =  "/home/franz/Dropbox/Me/ECOLOGIE/Coral_reefs/Nouvelle_Caledo/stage_Floriant/data_env_copernicus/downs/" #Make sure to end your path with "/" 
